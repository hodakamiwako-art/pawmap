...
- **地下鉄・鉄道を重ねて表示**（ソウル11路線・448駅、駅名は日本語／英語）
...
- **外国語対応は分かりません。** どの動物病院が日本語や英語に対応できるかを示す公開データは韓国に存在しません。サイトを持つ427軒を実際に読んで確認しましたが、外国語ページが見つかったのは4軒だけでした。そのため対応可否での絞り込みは提供せず、代わりに受付で見せる韓国語のフレーズを詳細画面に載せています
